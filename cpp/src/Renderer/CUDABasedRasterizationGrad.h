...
class CUDABasedRasterizationGrad
{
	...
	public:
		...
		inline bool*							get_D_visibilitis()						{ return input.d_visibilities; };
		...
		inline float3*							get_D_renderBuffer()						{ return input.d_renderBuffer; };
		inline float3*							get_D_vertexColorBuffer()					{ return input.d_vertexColorBuffer; };
		...
		inline void							set_D_renderBuffer(float3* newRenderBuffer)						{ input.d_renderBuffer = newRenderBuffer; };
		inline void							set_D_vertexColorBuffer(float3* newVertexColorbuffer)			{ input.d_vertexColorBuffer = newVertexColorbuffer; };
